        ...
        for(var j=1; j<4; j++){
            if(board[i][j] != 0){
                ...
                for(var k=0; k<j; k++){
                    ...
                    else if(board[i][k] == board[i][j] && !noBlockHorizontal(i,k,j,board) && !changed[i][k]){
                        //move
                        showMoveAnimation(i,j,i,k);
                        //add
                        board[i][k] += board[i][j];
        ...
        for(var j=2; j>=0; j--){
            if(board[i][j] != 0){
                ...
                for(var k=3; k>j; k--){
                    ...
                    else if(board[i][k] == board[i][j] && !noBlockHorizontal(i,j,k,board) && !changed[i][k]){
                        //move
                        showMoveAnimation(i,j,i,k);
                        //add
                        board[i][k] += board[i][j];
        ...
        for(var j=1; j<4; j++){
            if(board[j][i] != 0){
                ...
                for(var k=0; k<j; k++){
                    ...
                    else if(board[k][i] == board[j][i] && !noBlockVertical(i,k,j,board) && !changed[k][i]){
                        //move
                        showMoveAnimation(j,i,k,i);
                        //add
                        board[k][i] += board[j][i];
        ...
        for(var j=2; j>=0; j--){
            if(board[j][i] != 0){
                ...
                for(var k=3; k>j; k--){
                    ...
                    else if(board[k][i] == board[j][i] && !noBlockVertical(i,j,k,board) && !changed[k][i]){
                        //move
                        showMoveAnimation(j,i,k,i);
                        //add
                        board[k][i] += board[j][i];
